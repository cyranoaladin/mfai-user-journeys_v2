...
export const journeys: Journey[] = [
  {
    ...
    description: "Perfect for Web2-native, knowledge seekers who are time-rich and looking to gain concrete skills, passive income, and join a DAO.",
    phases: [
      {
        title: "Learn",
  ...
  },
  {
    ...
    description: "Designed for product owners and Web2 business builders looking to tokenize a business idea and create sustainable Web3 revenue.",
    phases: [
      {
        title: "Learn",
  ...
  },
  {
    ...
    description: "For financially driven individuals curious about DeFi & passive yield who want to discover, stake, vote, and earn within MFAI's economy.",
    phases: [
      {
        title: "Learn",
  ...
  },
  {
    ...
    description: "For developers or technical users ready to build tools, create a dApp or module within the MFAI ecosystem.",
    phases: [
      {
        title: "Learn",
  ...
  },
  {
    ...
    description: "For teachers, coaches, and content creators who want to train, lead, and grow the ecosystem from inside.",
    phases: [
      {
        title: "Learn",
  ...
  },
  {
    ...
    description: "For inventors with strong ideas but no execution path who want to validate and incubate a powerful Web3 vision.",
    phases: [
      {
        title: "Learn",
